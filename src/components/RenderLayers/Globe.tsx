...
const Globe: React.FC<GlobeProps> = ({ onCountrySelect }) => {
  ...
  const [dayMap, nightMap, cloudMap, normalMap, specularMap] = useGzipTexture([
    '/Gesalt_Dashboard/assets/textures/8k_day_map.jpg.gz',
    '/Gesalt_Dashboard/assets/textures/8k_night_map.jpg.gz',
    '/Gesalt_Dashboard/assets/textures/8k_clouds.jpg.gz',
    '/Gesalt_Dashboard/assets/textures/8k_normal_map.jpg.gz',
    '/Gesalt_Dashboard/assets/textures/8k_specular_map.jpg.gz'
  ]);
