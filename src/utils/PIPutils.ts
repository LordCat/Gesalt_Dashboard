...
// Updated to process a single country's polygon
...
// New function to create a BufferGeometry for a country
export function createCountryGeometry(
  ...
  if (feature.geometry.type === 'Polygon') {
    positions.push(...processPolygon(feature.geometry.coordinates, radius));
  } else if (feature.geometry.type === 'MultiPolygon') {
    feature.geometry.coordinates.forEach(polygon => 
      positions.push(...processPolygon(polygon, radius))
    );
  }
